...
my_bool opt_rds_permission_control;
bool thread_cache_size_specified= false;
bool host_cache_size_specified= false;
bool table_definition_cache_specified= false;
ulong locked_account_connection_count= 0;
uint combine_engine_log_flush_threshold;
...
int init_common_variables()
{
  ...
  */
  mysql_bin_log.set_psi_keys(key_BINLOG_LOCK_index,
                             ...
                             key_BINLOG_LOCK_flush_engine_queue,
                             key_BINLOG_LOCK_flush_binlog_queue,
                             key_BINLOG_LOCK_log,
                             key_BINLOG_LOCK_binlog_end_pos,
                             key_BINLOG_LOCK_sync,
                             key_BINLOG_LOCK_sync_queue,
                             key_BINLOG_LOCK_xids,
                             key_BINLOG_LOCK_flush_engine,
...
#define SUPER_LARGE_PAGESIZE (256*1024*1024)  /* 256MB */
  ...
  */
  ...
  if (rds_reserved_users_ptr &&
      !is_valid_rds_reserved_users(rds_reserved_users_ptr, strlen(rds_reserved_users_ptr)))
  {
    sql_print_error("Invalid value for --rds_reserved_users: %s",
    		         rds_reserved_users_ptr);
    return 1;
  }
...
#define FIX_LOG_VAR(VAR, ALT)                                   \
  ...
  // init reserved users
  if (rds_reserved_users_init() || rds_reserved_users_update(rds_reserved_users_ptr))
  {
    sql_print_error("An error occurred while storing rds_reserved_users to a hash.");
    return 1;
  }
...
#endif
{
  ...
  */
  ...
  sql_print_information("[MYSQL-DEBUG] %s is using '%s' malloc library",
                        my_progname, MALLOC_LIBRARY);
  sql_print_information("[MYSQL-DEBUG] secure C library: '%s'", SECURE_C_LIBRARY);
  sql_print_information("[MYSQL-DEBUG] ssl library: '%s'", SSL_LIBRARY);
...
PSI_mutex_key key_BINLOG_LOCK_flush_engine_queue;
PSI_mutex_key key_BINLOG_LOCK_flush_binlog_queue;
...
PSI_mutex_key key_BINLOG_LOCK_flush_engine;
PSI_mutex_key
  key_hash_filo_lock,
...
PSI_mutex_key key_RELAYLOG_LOCK_flush_engine_queue;
PSI_mutex_key key_RELAYLOG_LOCK_flush_binlog_queue;
...
PSI_mutex_key key_RELAYLOG_LOCK_flush_engine;
...
static PSI_mutex_info all_server_mutexes[]=
{
  ...
  { &key_BINLOG_LOCK_flush_engine_queue, "MYSQL_BIN_LOG::LOCK_flush_engine_queue", 0 },
  { &key_BINLOG_LOCK_flush_binlog_queue, "MYSQL_BIN_LOG::LOCK_flush_binlog_queue", 0 },
  ...
  { &key_BINLOG_LOCK_flush_engine, "MYSQL_BIN_LOG::LOCK_flush_engine", 0 },
  ...
  { &key_RELAYLOG_LOCK_flush_engine_queue, "MYSQL_RELAY_LOG::LOCK_flush_engine_queue", 0},
  { &key_RELAYLOG_LOCK_flush_binlog_queue, "MYSQL_RELAY_LOG::LOCK_flush_binlog_queue", 0 },
  ...
  { &key_RELAYLOG_LOCK_flush_engine, "MYSQL_RELAY_LOG::LOCK_flush_engine", 0},
