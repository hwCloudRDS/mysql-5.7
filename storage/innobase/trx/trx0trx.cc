				...
				written */
{
	...
	if (trx_is_autocommit_non_locking(trx)) {
        ...
        /* Note the tran has already been removed from the list of
         * active trans by code in trx_commit_low() -- though we
         * may consider back-porting BUG#21433768 and its follow-up
         * fixes to make this cleaner.*/
