				 ...
				 my_off_t log_pos)
{
  ...
  */
  ...
  {
    THD *theTHD = current_thd;
    if (theTHD == NULL || true == ack_receiver.add_slave(theTHD))
    {    
...
static int semi_sync_master_plugin_init(void *p)
{
  ...
  if (my_create_thread_local_key(&THR_RPL_SEMI_SYNC_DUMP, NULL))
    return 1;
