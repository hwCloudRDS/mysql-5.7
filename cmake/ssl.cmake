...
MACRO (MYSQL_USE_BUNDLED_OPENSSL)
  SET(OPENSSL_SOURCE_DIR "${CMAKE_SOURCE_DIR}/extra/openssl/repo")
  SET(OPENSSL_BINARY_DIR "${CMAKE_BINARY_DIR}/extra/openssl/src/openssl")

  SET(OPENSSL_CONFIGURE_OPTS -fPIC no-shared --openssldir=${OPENSSL_INSTALL_DIR})
  ...
  ExternalProject_Add(openssl
    ...
    URL ${OPENSSL_SOURCE_DIR}
    BINARY_DIR ${OPENSSL_BINARY_DIR}
    CONFIGURE_COMMAND "./config" ${OPENSSL_CONFIGURE_OPTS}
    BUILD_COMMAND ${MAKE_COMMAND} 
    INSTALL_COMMAND ""
  )

  ExternalProject_Get_Property(openssl BINARY_DIR)
  SET(SSL_INCLUDE_DIRS ${BINARY_DIR}/include)
...
MACRO (MYSQL_CHECK_SSL)
  ...
  IF(WITH_SSL STREQUAL "openssl")
    ...
    SET(SSL_LIBRARY "openssl (bundled)")
  ...
  ELSEIF(WITH_SSL STREQUAL "system" OR
    ...
    IF (WITH_SSL_PATH)
      ...
      SET(SSL_LIBRARY "openssl (${WITH_SSL_PATH})")
    ELSE()
      SET(SSL_LIBRARY "openssl (system)")
    ENDIF()
