...
struct _db_stack_frame_ {
  ...
  ulonglong enter_time;
  ulonglong callee_time;
...
extern  void _db_profile_end_(my_thread_id id, struct _db_code_state_ * cs);
...
#define DBUG_PROFILE_END(a1, a2)   _db_profile_end_((a1), (a2))
...
#define DBUG_PROFILE_END(a1)            do { } while(0)

#endif


#if !defined(DBUG_OFF) && defined(ENABLED_DEBUG_SYNC)
#define DBUG_ENABLED_DEBUG_SYNC
#endif

#ifdef DBUG_ENABLED_DEBUG_SYNC
